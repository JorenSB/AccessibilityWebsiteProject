    ...
    const updateUserData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Voer hier eventueel extra logica uit na een succesvolle update
          console.log(updatedData.disabilities);
        } else {
      ...
      <BaseLayout>
        <div className='profileContainer'>
          <div className='col1'>
            ...
            <BenaderInfo onUpdateData={handleDataChange} emailPreference={userData.emailPreference} phonePreference={userData.phonePreference} commercial={userData.commercial} />
