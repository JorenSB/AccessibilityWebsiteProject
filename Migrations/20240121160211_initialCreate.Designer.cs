...
namespace AccessibilityWebsiteProject.Migrations
{
    ...
    [Migration("20240121160211_initialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DisabilityAidExpert", b =>
                {
                    b.Property<int>("DisabilityAidsDisabilityAidId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Users.Expert.DisabilityAid", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DisabilityAidId"));
            ...
            modelBuilder.Entity("Result", b =>
                {
                    b.HasOne("Study", "Study")
                        .WithOne("Result")
                        .HasForeignKey("Result", "StudyID");
